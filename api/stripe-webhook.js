...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (event.type === 'checkout.session.completed') {
      customerId = customerId || obj.customer || null;
      subscriptionId = subscriptionId || obj.subscription || null;
      userId = userId || obj.metadata?.supabase_user_id || null;
    }
    ...
    if (event.type === 'invoice.payment_failed' && !status) status = 'past_due';
